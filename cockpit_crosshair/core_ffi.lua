...
function FFI_CheckInit()
    ...
    if XPLM ~= nil then print("Cockpit Crosshair FFI: Initialized!") end
    print("Cockpit Crosshair FFI: Operating system detected as "..ffi.os)
end
...
function Get_Folder()
    ...
    folderpath = filePath.."plugins/xlua/scripts/cockpit_crosshair"
    return folderpath
end
